...
return'false';}
if(Utl.type(data.timestamp)==="date"){timestamp=scorm.getAPIVersion()==="1.2"?scorm.dateToscorm12Time(data.timestamp):scorm.get("time_type")==="UTC"?scorm.isoDateToStringUTC(data.timestamp):scorm.isoDateToString(data.timestamp);}
