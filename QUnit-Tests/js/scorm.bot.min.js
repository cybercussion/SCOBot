...
i-=1;}
return'false';};this.init=function(){var win;try{win=window.parent;if(win&&win!==window){this[defaults.preferred_API](window.parent);}}catch(e){debug(settings.prefix+" Possible Cross-domain issue/local mode (ignore).",2);}
if(!API.path){try{win=window.top.opener;this[defaults.preferred_API](win);}catch(ee){debug(settings.prefix+" Possible Cross-domain issue/local mode (ignore).",2);}}
