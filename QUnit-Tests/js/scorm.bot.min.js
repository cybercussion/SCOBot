...
return settings[n];};Utl.addEvent(window,'loaded',initSCO);Utl.addEvent(window,'unload',exitSCO);Utl.addEvent(scorm,'exception',function(e){triggerException(e.error);});}