...
ec=getLastErrorCode();m=getLastErrorMessage(ec);d=getDiagnostic(ec);Utl.triggerEvent(self,'getvalue',{'n':n,'v':v,'error':{'code':ec,'message':m,'diagnostic':d}});if(ec===0||ec===403){if(v==='undefined'||v===null||v==='null'){v="";}
