...
return notStartedYet();};this.timeout=function(){if(isStarted){setSuspendData();scorm.debug(settings.prefix+": I am timing out...",3);scorm.setvalue('cmi.exit','time-out');updateStatus();isStarted=false;return scorm.terminate();}
