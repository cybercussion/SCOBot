...
return'true';}
return notStartedYet();};this.debug=scorm.debug;this.getvalue=scorm.getvalue;this.setvalue=scorm.setvalue;this.getMode=function(){if(isStarted){return settings.mode;}
