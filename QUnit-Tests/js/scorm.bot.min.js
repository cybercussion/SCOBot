...
if(!$.isPlainObject(cmi.interactions[tiers[2]])){if(tiers[3]==="id"){cmi.interactions[tiers[2]]={};setData(k.substr(4,k.length),v,cmi);cmi.interactions._count=(getObjLength(cmi.interactions)-2).toString();if(cmi.interactions[tiers[2]].objectives===undefined){scorm.debug(settings.prefix+": Constructing objectives object for new interaction",4);cmi.interactions[tiers[2]].objectives={};cmi.interactions[tiers[2]].objectives._count="-1";cmi.interactions[tiers[2]].objectives._children="id,score,success_status,completion_status,description";}
...
setData(k.substr(4,k.length),v,cmi);cmi.interactions[tiers[2]].objectives._count=(getObjLength(cmi.interactions[tiers[2]].objectives)-2).toString();return'true';}
if(tiers[3]==='correct_responses'){scorm.debug("Setting correct responses count to "+(getObjLength(cmi.interactions[tiers[2]].correct_responses)).toString());setData(k.substr(4,k.length),v,cmi);cmi.interactions[tiers[2]].correct_responses._count=(getObjLength(cmi.interactions[tiers[2]].correct_responses)).toString();return'true';}
