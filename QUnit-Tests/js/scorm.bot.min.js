...
return lmsconnected;}
function exitSCO(){if(!isExit){isExit=true;$(self).triggerHandler({'type':"unload"});if(scorm.get('exit_type')==="normal"){self.finish();}else{self.suspend();}
...
function verifyScoreScaled(){var success=scorm.getvalue('cmi.success_status');if(success==='passed'&&scorm.get('exit_type')==="normal"){if(scorm.getvalue('cmi.score.scaled')==='false'){if(scorm.getvalue('cmi.score.max')==='1'){scorm.setvalue('cmi.score.scaled','1');}}}}
