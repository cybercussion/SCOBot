...
this.isRunning=function(){return settings.initialized===1&&settings.terminated===0;};this.Initialize=function(){scorm.debug(settings.prefix+":  Initializing...",3);if(settings.cmi!==null){cmi=settings.cmi;}else{cmi=settings.CMI;}
...
p1+=n+'.';if(f){if(!isBadValue(data.id)){sv(p1+'id',data.id.toString());}else{scorm.debug(settings.prefix+": You did not pass an objective ID!!",1);return'false';}}
