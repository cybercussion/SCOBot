...
return value;case'matching':if($.isArray(value)){len=value.length;i=0;while(i<len){if($.isArray(value[i])){arr.push(value[i].join("[.]"));}else{scorm.debug(settings.prefix+": Developer, you're not passing a array type for matching/performance.  I got "+typeof value+" instead",1);return'';}
i+=1;}
